  ...
  return (
    <ResponsiveLayout>
      <div className="w-full py-8">
        ...
        {/* Combined Stats Grid: Responsif (1 kolom mobile, 2 tablet, 4 desktop) */}
        ...
        {/* Secondary stats grid: Responsif (1 kolom mobile, 3 desktop) */}
        ...
        {/* Charts: Responsif (otomatis stack di mobile) */}
