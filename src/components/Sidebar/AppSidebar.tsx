    ...
    <>
      ...
      <div className="w-[68px] min-w-[68px] lg:w-[250px] lg:min-w-[250px] h-screen sticky top-0 bg-transparent flex-shrink-0 z-50">
        ...
        >
          ...
          >
            <div
              className={`w-full items-center justify-between lg:flex ${isExpanded ? "flex" : "hidden"}`}
            >
            ...
            <div
              className={`p-1.5 rounded text-gray-400 hover:text-white hover:bg-[#2A2A2C] transition-colors lg:hidden ${!isExpanded ? "block" : "hidden"}`}
            >
            ...
            >
              ...
              <div
                className={`items-center justify-between flex-1 min-w-0 lg:flex lg:max-w-full lg:opacity-100 lg:visible lg:ml-1 ${
                  isExpanded
                    ? "flex max-w-full opacity-100 visible ml-1"
                    : "hidden max-w-0 opacity-0 invisible"
                }`}
              >
            ...
            {user ? (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`overflow-hidden transition-all duration-300 lg:max-w-full lg:opacity-100 lg:ml-2 ${isExpanded ? "max-w-full opacity-100 ml-2" : "max-w-0 opacity-0"}`}
                  >
